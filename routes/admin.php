...
Route::group(['namespace' => 'Admin'], function () {
    ...
    Route::group(['middleware' => ['auth:admin']], function () {
        ...
        Route::group(['middleware' => ['permission']], function () {
            ...
            // Call review
            Route::get('call_review', 'ContactController@listCallReview')->name('call_review.index');
            Route::get('call_review/{review}', 'ContactController@showCallReview')->name('call_review.show');
            Route::put('call_review/{review}', 'ContactController@update_review')->name('call_review.update');
            Route::delete('call_review/{review}', 'ContactController@destroy_review')->name('call_review.destroy');
