            ...
            <div class="row">
                <div class="col-lg-3 col-12">
                    <a href="<?php echo e(route('frontend.home')); ?>" class="logo">  
                        <img width="170" height="43" src="<?php echo e($web_information->image->logo_footer ?? ''); ?>" alt="Ngân hoa">
                      </a>
                      <br>
                    ...
                    <ul>
                        ...
                        <li>Điện thoại: <a class="fone"
                            ...
                            - Email: <a
                                href="mailto:<?php echo e($web_information->information->email ?? ''); ?>"><?php echo e($web_information->information->email ?? ''); ?></a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="row tablet">
                    <div id="copyright" class="col-lg-12 col-md-12 col-12">
                        <div class="wsp text-center">
                            Copyright@ 2024 <?php echo e($web_information->information->site_name ?? ''); ?>
...
<?php /**PATH E:\xampp\htdocs\ttech\resources\views/frontend/blocks/footer/styles/default.blade.php ENDPATH**/ ?>