...
<div class="bottom-nav-bar-mobile">
  <div class="inner-group container">
    <div class="itembar" onclick="location.href='<?php echo e(route('frontend.home')); ?>'s">
      <div class="bar-menu">
        <div class="icon">
        ...
        <a href="<?php echo e(route('frontend.home')); ?>">Trang chủ</a>
      </div>
    </div>
    <div class="itembar">
    ...
    <div class="itembar" onclick="location.href='<?php echo e(route('frontend.contact')); ?>';">
      <div class="bar-menu">
        <div class="icon">
