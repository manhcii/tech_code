...
class ContactController extends Controller
{
    ...
    public function listCallReview(Request $request)
    {
        $this->responseData['module_name'] = __('Call review Management');
        $params = $request->all();
        $this->responseData['params'] = $params;
        // Get list with filter params
        ...
        return $this->responseView($this->viewPart . '.call_review_list');
    }
    ...
    public function showCallReview(Review $review)
    {
        $this->responseData['module_name'] = __('Call review Management');
        $this->responseData['detail'] = $review;

        return $this->responseView($this->viewPart . '.call_review_show');
    }
}
